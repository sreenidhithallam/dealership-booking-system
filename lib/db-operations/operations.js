...
function databaseInitialize() {
    ...
    bookingCapacity = db.getCollection('bookingCapacity');
...
function setCapacity(capacity) {
    const bookingCapacityRecords = bookingCapacity.chain().find('bookingCapacity').data();

    bookingCapacity
    .findAndUpdate({ 'bookingCapacity': bookingCapacityRecords[0].bookingCapacity }, function (obj) {
